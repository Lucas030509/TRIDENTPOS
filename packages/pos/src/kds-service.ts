/**
 * TRIDENTPOS KDS Domain Service (WP-015)
 * Pure business logic implementing the FUNCTIONAL_ARCHITECTURE.md Sec. 6.1
 * "Contrato TRIDENTPOS <-> KDS" functional commands/queries. Never imports
 * infrastructure (@trident/edge) -- transport (WebSocket broadcast, printing)
...
export class KdsDomainService {
   ...
   * Hito operacional formal de confirmacion de produccion (FUNCTIONAL_ARCHITECTURE.md Sec 6.1).
   */
  ...
  #emit(type: KdsDomainEvent['type'], ticket: KdsTicket): void {
