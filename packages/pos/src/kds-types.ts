/**
 * TRIDENTPOS KDS Domain Types (WP-015)
 * Kitchen Display System ticket/estación/printer domain model.
 * Conforms to FUNCTIONAL_ARCHITECTURE.md Sec. 3 & 6.1 (Contrato TRIDENTPOS <-> KDS) and ADR-005.
 * All quantities are canonical scale-4 decimal strings (transport-safe, ADR-012 convention);
...
export interface KdsTicketPartida {
  ...
  readonly quantity: string; // canonical 4-decimal string
