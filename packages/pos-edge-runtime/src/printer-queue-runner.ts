/**
 * TRIDENTPOS KDS Printer Queue Runner (WP-015, ACR-2026-016)
 ...
 *
 * Implements the canonical 5-state print lifecycle:
 * PENDING -> QUEUED -> PRINTING -> PRINTED / FAILED.
 *
 ...
 * always marks the ticket FAILED/QUEUED (durably queued in SQLite, eligible
