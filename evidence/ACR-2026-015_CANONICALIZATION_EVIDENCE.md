...
> This is durable, merged governance evidence for the `ACR-2026-015` canonical amendment candidate. It references the full governance lineage by exact commit SHA. It does not itself canonicalize anything — canonicalization occurs only when the candidate branch this file lives on is independently reviewed and merged into `main`.
...
| `ARCHITECTURE_CHANGE_REQUEST_SALON_PRODUCTIZATION.md` | Added (copied verbatim from frozen subject `2c90a43c5dcfe0b01a80f60bf4c0ca529c1d13d9`, metadata-only status update) |
| `docs/governance/TRIDENTPOS_SALON_PRODUCTIZATION_MATRIX.md` | Added (copied verbatim from frozen subject, metadata-only status update) |
...
*This evidence file is durable, merged, and travels with the canonical amendment candidate branch `architecture/acr-2026-015-canonical-amendment`. It does not itself canonicalize anything, authorize any Work Package to start, close any protected decision, or modify `main`.*
